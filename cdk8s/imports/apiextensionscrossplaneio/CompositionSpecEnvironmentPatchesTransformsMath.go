...
type CompositionSpecEnvironmentPatchesTransformsMath struct {
	...
	Type CompositionSpecEnvironmentPatchesTransformsMathType `field:"optional" json:"type" yaml:"type"`
}
