...
type CompositionSpecPatchSetsPatchesPolicy struct {
	...
	FromFieldPath CompositionSpecPatchSetsPatchesPolicyFromFieldPath `field:"optional" json:"fromFieldPath" yaml:"fromFieldPath"`
	// MergeOptions Specifies merge options on a field path.
	MergeOptions *CompositionSpecPatchSetsPatchesPolicyMergeOptions `field:"optional" json:"mergeOptions" yaml:"mergeOptions"`
}
