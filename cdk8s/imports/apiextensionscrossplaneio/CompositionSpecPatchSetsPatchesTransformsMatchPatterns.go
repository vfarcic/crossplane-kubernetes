...
type CompositionSpecPatchSetsPatchesTransformsMatchPatterns struct {
	...
	Type CompositionSpecPatchSetsPatchesTransformsMatchPatternsType `field:"required" json:"type" yaml:"type"`
