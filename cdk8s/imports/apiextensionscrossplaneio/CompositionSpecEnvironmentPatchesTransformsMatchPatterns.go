...
type CompositionSpecEnvironmentPatchesTransformsMatchPatterns struct {
	...
	Type CompositionSpecEnvironmentPatchesTransformsMatchPatternsType `field:"required" json:"type" yaml:"type"`
