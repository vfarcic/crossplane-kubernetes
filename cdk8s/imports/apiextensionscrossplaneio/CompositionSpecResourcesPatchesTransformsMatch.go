...
type CompositionSpecResourcesPatchesTransformsMatch struct {
	// Determines to what value the transform should fallback if no pattern matches.
	FallbackTo CompositionSpecResourcesPatchesTransformsMatchFallbackTo `field:"optional" json:"fallbackTo" yaml:"fallbackTo"`
	...
	Patterns *[]*CompositionSpecResourcesPatchesTransformsMatchPatterns `field:"optional" json:"patterns" yaml:"patterns"`
}
